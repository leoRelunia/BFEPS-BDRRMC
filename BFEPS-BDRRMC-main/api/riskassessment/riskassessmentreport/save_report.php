...
$required_fields = ['household_zone', 
                    'risk_type', 
                    'household_head_name', 
                    'risk_description', 
                    'risk_impact_level', 
...
$stmt = $conn->prepare("INSERT INTO risk_assessment (household_zone, risk_type, household_head_name, risk_description, num_of_pwd, num_of_senior, num_of_infant_toddler, num_of_flood_fatality, num_of_property_damage, damage_description, impacted_remarks, risk_impact_level, risk_probability_level, risk_severity_level, current_control_measures, option_action, action_remarks) 
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
