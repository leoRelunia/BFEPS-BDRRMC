...
$required_fields = ['calamity_name', 
                    'situation_overview', 
                    'response_actions', 
                    'immediate_needs', 
                    'recommendations_needs'];
...
$stmt = $conn->prepare("INSERT INTO situational_report (calamity_name, situation_overview, response_actions, immediate_needs, recommendations_needs)
                       VALUES (?, ?, ?, ?, ?)");
