...
import 'package:bfeps_bdrrmc/screen/profiling/resident_details.dart';
...
class IndividualPageState extends State<IndividualPage> {
  ...
  Future<void> _fetchRecords() async {
    try {
      final url = Uri.parse('http://localhost/BFEPS-BDRRMC-main/BFEPS-BDRRMC-main/api/profiling/individual_record.php');
