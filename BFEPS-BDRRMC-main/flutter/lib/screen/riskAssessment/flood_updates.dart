...
Future<void> _fetchRecords() async {
    try {
      final url = Uri.parse('http://localhost/BFEPS-BDRRMC-main/BFEPS-BDRRMC-main/api/riskassessment/floodupdate/get_update.php'); 
...
void _deleteReport(String id) async {
    ValidationDialog.showDeleteDialog(
      ...
      onConfirm: () async {
        ...
        try {
          final url = Uri.parse('http://localhost/BFEPS-BDRRMC-main/BFEPS-BDRRMC-main/api/riskassessment/floodupdate/delete_report.php');
...
//     var request = http.MultipartRequest('POST', Uri.parse('http://localhost/BFEPS-BDRRMC-main/BFEPS-BDRRMC-main/api/riskassessment/floodupdate/upload_image.php'));
  ...
  if (// imageController.text.isNotEmpty &&
    ...
    try {
      ...
      final data = {
       ...
       var url = Uri.parse('http://localhost/BFEPS-BDRRMC-main/BFEPS-BDRRMC-main/api/riskassessment/floodupdate/save_update.php');
