...
class _HeaderBarState extends State<HeaderBar> {
  ...
  String _position = '';  // Variable to store the position

  @override
  void initState() {
    super.initState();
    _loadPosition();  // Load position when the widget is initialized
  }

  // Load the position from SharedPreferences
  void _loadPosition() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    setState(() {
      _position = prefs.getString('position') ?? '';  // Default to empty if no position is stored
    });
  }
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Text(
                  _position.isEmpty ? 'Loading...' : _position,  // Display the position dynamically
