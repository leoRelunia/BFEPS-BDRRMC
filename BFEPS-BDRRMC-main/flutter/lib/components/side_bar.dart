import 'package:bfeps_bdrrmc/screen/riskAssessment/sit.rep.dart';
        ...
        children: [
          ...
          _buildMenuItem(
            ...
            onTap: () => _handleAccessControl(
              ...
              label: 'Calamity',
              page: CalamityPage(onMenuSelect: widget.onMenuSelect), // Pass the parameter here
            ),
          ),
          _buildMenuItem(
          ...
          _buildMenuItem(
            ...
            isSelected: widget.selectedMenu == 'Situation',
            onTap: () => _handleAccessControl(
